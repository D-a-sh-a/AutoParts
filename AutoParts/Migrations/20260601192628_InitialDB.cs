        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AutoParts_Brands_BrandId",
                        column: x => x.BrandId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_AutoParts_AutoPartId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AutoPartVehicle", x => new { x.AutoPartsId, x.VehiclesId });
                    table.ForeignKey(
                        name: "FK_AutoPartVehicle_AutoParts_AutoPartsId",
                        column: x => x.AutoPartsId,
                        principalTable: "AutoParts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AutoPartVehicle_Vehicles_VehiclesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AutoPartVehicle_VehiclesId",
                table: "AutoPartVehicle",
                column: "VehiclesId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_AutoPartId",
                table: "OrderItems",
                column: "AutoPartId");
